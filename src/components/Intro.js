  ...
  return (
    <div className="Intro flexbox-container" id="INTRO">
      ...
      <div className="intro section">
        <span>
          <span className="t2">Hongwei Wang</span> (pronoun: he/him) is a
          ...
          Psychology. He loves to know people from the hotel industry. His
          favorite brand is Hyatt but he only has an elite status in Marriott.
          <br />
          <br />
